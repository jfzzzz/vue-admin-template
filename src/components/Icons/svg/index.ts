import { createIconifyIcon } from '@/plugins/icons';
...
const SvgCardFileBoxIcon = createIconifyIcon('svg:card-file-box');
const SvgHospitalIcon = createIconifyIcon('svg:hospital');
